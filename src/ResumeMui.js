    ...
    return (
        <Grid container width='100%'>
            <Grid container item direction='row' alignItems='flex-start' justifyContent='space-between' p={2} className="firstRow">
                <Grid container item direction='column' xs={12} lg={4} order={1} py={2} px={{ xs: 1, md: 4, xl: 5 }} alignItems='flex-start' className="about">
                ...
                <Grid container item direction='column' xs={12} sm={6} lg={4} order={{ xs: 1, lg: 2 }} py={2} px={{ xs: 1, md: 4, xl: 5 }} alignItems='flex-start' className="about">
                    <Contact />
                </Grid>

                <Grid container item direction='column' xs={12} sm={6} lg={4} order={{ xs: 2, lg: 1 }} py={2} px={{ xs: 1, md: 4, xl: 5 }} alignItems='flex-start' className="about">
                    <About />
                </Grid>

            </Grid>
            <Grid container item direction='row' justifyContent={{ xs: 'center', sm: 'space-between', md: 'space-evenly' }} p={2} bgcolor='white'>
                <Grid container item direction='column' xs={12} md={6} lg={4} py={2} px={{ xs: 1, md: 4, xl: 5 }} className="skills">
                ...
                <Grid container item direction='column' xs={12} md={6} lg={4} py={2} px={{xs: 1, md: 4, xl: 5}}>
                    <Experience />
                </Grid>
                <Grid container item direction='column' xs={12} md={6} lg={4} py={2} px={{xs: 1, md: 4, xl: 5}} display={{xs: 'inline-block', sm: 'none', lg: 'inline-block'}}>
                    <Education />
                </Grid>
            </Grid>
        </Grid>
