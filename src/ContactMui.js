...
export default function Contact() {
    return (
        <>
            <Typography sx={{ fontSize: '1.75rem', fontWeight: '600' }} color={blue[500]}>Contact</Typography>
            <Divider sx={{ mt: 1, mb: 2, color:'white' }} />
            <Grid container item direction='column' alignItems='flex-start' rowGap={2}>
                <List sx={{ height: '100%', width: '100%' }}>
                    <ListItemButton href='mailto: andrwmg@gmail.com' sx={{ height: '100%', width: '100%', color: blue[500], px: 0 }}>
                        <ListItemIcon>
                            <MailTwoTone sx={{ color: blue[500] }} />
                        </ListItemIcon>
                        <ListItemText>
                            andrwmg@gmail.com
                        </ListItemText>
                    </ListItemButton>
                    <ListItemButton href='tel:6108884468' sx={{ height: '100%', width: '100%', color: blue[500], px: 0 }}>
                        <ListItemIcon>
                            <PhoneTwoTone sx={{ color: blue[500] }} />
                        </ListItemIcon>
                        <ListItemText>
                            610-888-4468
                        </ListItemText>
                    </ListItemButton>
                    <ListItemButton href='https://www.andrewmichaelgay.com' sx={{ height: '100%', width: '100%', color: blue[500], px: 0 }}>
                        <ListItemIcon>
                            <WebTwoTone sx={{ color: blue[500] }} />
                        </ListItemIcon>
                        <ListItemText>
                            andrewmichaelgay.com
                        </ListItemText>
                    </ListItemButton>
                    <ListItemButton href='https://www.linkedin.com/in/andrwmg' sx={{ height: '100%', width: '100%', color: blue[500], px: 0 }}>
                        <ListItemIcon>
                            <LinkedIn sx={{ color: blue[500] }} />
                        </ListItemIcon>
                        <ListItemText>
